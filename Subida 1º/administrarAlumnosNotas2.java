...
public class administrarAlumnosNotas2 {
	...
	public static void main (String []args) {
		...
		Alumno Jose = new Alumno ("José");
		Alumno Ana = new Alumno ("Ana");
		
		//Añadir alumnos  a la arraylist.
		...
		/* 
		//Zona de los números aleatorios.
		...
		*/
		//Añadir notas de los examenes clásicos.
		...
		//Añadir las respuestas de examenes de tipo test.
		...
		do {
			...
			case "a","a)", "A", "A)": // ----------------------------------> CAMBIO A CONTAR A MARCELO
				...
				//El bucle terminará cuando se seleccione la opción "atrás" o no se encuentre el alumno introducido por teclado
				for (int i=0;i<length;i++) { //2do Bucle
					if (listaAlumnos.get(i).getNombre().equalsIgnoreCase(nombre)) {
						System.out.println("¿Que desea hacer?");
						//2do MENU
						System.out.println("a)Añadir notas de examen b)Mostrar examenes y trabajos hechos  c)Administrar entrega de trabajos  d)Atrás ");
